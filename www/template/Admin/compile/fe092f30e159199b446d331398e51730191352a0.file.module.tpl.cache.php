<?php /* Smarty version Smarty-3.0.8, created on 2011-07-12 17:05:31
         compiled from "V:/home/buket_debug/www/admin/module/PagesList/module.tpl" */ ?>
<?php /*%%SmartyHeaderCode:300624e1c2a7b2db6b4-53117727%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fe092f30e159199b446d331398e51730191352a0' => 
    array (
      0 => 'V:/home/buket_debug/www/admin/module/PagesList/module.tpl',
      1 => 1310467796,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '300624e1c2a7b2db6b4-53117727',
  'function' => 
  array (
  ),
...
",
                type:"post",
                data: { handlerBindSiteTree: "handlerBindSiteTree",
...
&parentId=0&title=Новый раздел",
        ...
        $("#btnDelete").click(function(){
            ...
            if (confirm('Удалить раздел? Все вложенные разделы будут удалены безвозвратно.'))
            {
                if(node){
                    node.remove();
                    $.ajax({
